...
!\[Interface Selection](Image (2).png)
...
!\[Ping Google](Image (7).png)  
!\[Ping Wikipedia](Image (8).png)  
!\[Ping Tesla](Image (9).png)
...
!\[DNS Query Response](Image (11).png)
...
**Filter:**  
`ip.addr == <YOUR\_IP\_ADDRESS>`

**Observation:**

* Displays traffic to/from the specified IP.

!\[IP Filter](Image (13).png)
